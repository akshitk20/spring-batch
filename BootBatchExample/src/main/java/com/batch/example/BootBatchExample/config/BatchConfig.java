...
public class BatchConfig {
    ...
    public Step steps(JobRepository jobRepository, DataSourceTransactionManager transactionManager, ItemReader<Product> reader
                     , ItemProcessor<Product, Product> itemProcessor, ItemWriter<Product> writer) {
        return new StepBuilder("step", jobRepository)
                .<Product, Product>chunk(5, transactionManager)// data kitne tukdo mei jayega uski size kya hogi
                .reader(reader)
